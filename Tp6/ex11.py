...
L=[Stagiaire("E123456","nom1","prenom1","dev",13),Stagiaire("E123457","nom2","prenom2","dev",14),Stagiaire("E123458","nom3","prenom3","full stack",16)]
...
while True :
        while True:
            print("         Menu :      ")
            print("1-Affivher tous les stagiaires")
          ...
          if len(L) > 0 :
            ...
            try:
             if len(L) > 0 :
              ...
              print("La liste est vide , doit entrer au moins un stagiaire")
            except Exception as a:
                print(a)
